...
public class SavedFlightResponse {
	...
	public String toString() {
		return "SavedFlightResponse [flightId=" + flightId + ", departureTime=" + departureTime + ", arrivalTime="
				+ arrivalTime + ", fromPort=" + fromPort + ", toPort=" + toPort + ", price=" + price + ", airlineName="
				+ airlineName + ", availableMeals=" + availableMeals + ", totalCapacity=" + totalCapacity + "]";
	}
